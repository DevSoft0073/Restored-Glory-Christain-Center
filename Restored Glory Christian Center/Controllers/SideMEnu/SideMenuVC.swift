...
class SideMenuVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if role == "0" {
            sideMenuArray.append(SideMenuData(name: "Home",image: "home" , selected: true))
            sideMenuArray.append(SideMenuData(name: "Notification", image : "bell" ,selected: false))
//            sideMenuArray.append(SideMenuData(name: "Choir Rehearsal",image: "" , selected: false))
...
//            sideMenuArray.append(SideMenuData(name: "Glory Kids ", selected: false))
            sideMenuArray.append(SideMenuData(name: "About Us",image:  "info" , selected: false))
...
extension SideMenuVC : UITableViewDataSource , UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleImg.image = UIImage(named: sideMenuArray[indexPath.row].image)
...
//        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if role == "0" {
            ...
            if(indexPath.row == 0) {
                let vc = HomeScreenVC.instantiate(fromAppStoryboard: .Main)
                (sideMenuController?.rootViewController as! UINavigationController).pushViewController(vc, animated: true)
            }
...
//                vc.catTitle = "Men's Ministry"
                ...
                let vc = TermUseVC.instantiate(fromAppStoryboard: .Main)
//                vc.catID = "3"
